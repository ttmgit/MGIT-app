...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      { pattern: 'node_modules/quill/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/ngx-quill/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/@angular/material/bundles/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/ngx-sharebuttons/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/ngx-rating/**/*.js', included: false, watched: false },
      ...
      { pattern: 'node_modules/ngx-restangular/**/*.js', included: false, watched: false },
