  ...
  */
  ...
  SYSTEM_CONFIG_DEV: any = {
    ...
    paths: {
      ...
      'd3-brush': 'node_modules/d3-brush/build/d3-brush.js',
      'd3-shape': 'node_modules/d3-shape/build/d3-shape.js',
      'd3-selection': 'node_modules/d3-selection/build/d3-selection.js',
      'd3-color': 'node_modules/d3-color/build/d3-color.js',
      'd3-drag': 'node_modules/d3-drag/build/d3-drag.js',
      'd3-transition': 'node_modules/d3-transition/build/d3-transition.js',
      'd3-format': 'node_modules/d3-format/build/d3-format.js',
      'd3-force': 'node_modules/d3-force/build/d3-force.js',
      'd3-dispatch': 'node_modules/d3-dispatch/build/d3-dispatch.js',
      'd3-path': 'node_modules/d3-path/build/d3-path.js',
      'd3-ease': 'node_modules/d3-ease/build/d3-ease.js',
      'd3-timer': 'node_modules/d3-timer/build/d3-timer.js',
      'd3-quadtree': 'node_modules/d3-quadtree/build/d3-quadtree.js',
      ...
      'd3-hierarchy': 'node_modules/d3-hierarchy/build/d3-hierarchy.js',
      ...
      '@covalent/core': 'node_modules/@covalent/core/core.umd.js',
      'app/*': '/app/*',
      // For test config
  ...
  SYSTEM_BUILDER_CONFIG: any = {
    ...
    packageConfigPaths: [
      ...
      join('node_modules', '@covalent', '*', 'package.json')
    ],
    paths: {
